...
public class GUImanejador extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GUImanejador window = new GUImanejador();
	...
	private void initialize() {// falta tree
		...
		verboseBox.setBackground(Color.WHITE);
		verboseBox.setForeground(Color.WHITE);
		verboseBox.setVisible(false);
		...
		arribajo.setBackground(Color.WHITE);
		...
		tabbedPaneQuery.setBackground(Color.WHITE);
		...
		verboseArea.setBackground(Color.WHITE);
